      ...
      <Card className="overflow-hidden border-none shadow-xl rounded-xl">
        ...
        <div className="relative w-full h-[250px] md:h-[350px] bg-gradient-to-br from-purple-800 to-purple-600 dark:from-purple-900 dark:to-gray-800 overflow-hidden">
          ...
          <div className="absolute bottom-4 left-4 md:bottom-8 md:left-8">
            <Badge className="bg-yellow-400 hover:bg-yellow-500 text-purple-900 mb-2 px-3 py-1">{terreiro?.segment}</Badge>
            <h1 className="text-3xl md:text-4xl font-bold text-white">{terreiro?.name}</h1>
        ...
        <div className="flex flex-col md:flex-row md:justify-between px-4 md:px-8 py-4 border-b border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-950">
          <div className="flex items-center mb-4 md:mb-0">
            <div className="flex items-center">
              ...
              <span className="ml-2 text-gray-600 dark:text-gray-400 font-medium">4.0</span>
            </div>
            <span className="mx-3 text-gray-300 dark:text-gray-700">•</span>
            <span className="text-gray-600 dark:text-gray-400">42 avaliações</span>
          </div>
          <div className="flex gap-2">
            <Button 
              className="flex-1 md:flex-none rounded-full bg-purple-700 hover:bg-purple-800 text-white shadow-md"
            >
          ...
          <Tabs defaultValue="sobre" className="w-full">
            <div className="border-b border-gray-200 dark:border-gray-800 px-4 md:px-8">
              <TabsList className="bg-transparent h-14">
                <TabsTrigger value="sobre" className="data-[state=active]:text-purple-700 data-[state=active]:shadow-none data-[state=active]:border-b-2 data-[state=active]:border-purple-700 rounded-none h-14 px-4">
                  <Info className="mr-2 h-4 w-4" />
                  Sobre
                </TabsTrigger>
                <TabsTrigger value="eventos" className="data-[state=active]:text-purple-700 data-[state=active]:shadow-none data-[state=active]:border-b-2 data-[state=active]:border-purple-700 rounded-none h-14 px-4">
                  <CalendarDays className="mr-2 h-4 w-4" />
                  Eventos
                </TabsTrigger>
                <TabsTrigger value="membros" className="data-[state=active]:text-purple-700 data-[state=active]:shadow-none data-[state=active]:border-b-2 data-[state=active]:border-purple-700 rounded-none h-14 px-4">
                  <Users className="mr-2 h-4 w-4" />
                  Membros
                </TabsTrigger>
                <TabsTrigger value="fotos" className="data-[state=active]:text-purple-700 data-[state=active]:shadow-none data-[state=active]:border-b-2 data-[state=active]:border-purple-700 rounded-none h-14 px-4">
                  <Image className="mr-2 h-4 w-4" />
                  Fotos
                </TabsTrigger>
                <TabsTrigger value="avaliacao" className="data-[state=active]:text-purple-700 data-[state=active]:shadow-none data-[state=active]:border-b-2 data-[state=active]:border-purple-700 rounded-none h-14 px-4">
            ...
            <TabsContent value="sobre" className="p-4 md:p-8 focus:outline-none">
              <div className="grid grid-cols-1 gap-8">
                <section>
                  <h2 className="text-2xl font-bold text-purple-900 dark:text-white mb-6">Informações</h2>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="space-y-4">
                      <div className="flex items-start">
                        ...
                        <div>
                          <p className="text-sm text-gray-500 dark:text-gray-400">Dirigente</p>
                          <p className="font-medium text-gray-900 dark:text-white">{terreiro?.user.name}</p>
                        </div>
                      </div>
                      <div className="flex items-start">
                        <div className="mr-3 h-9 w-9 flex-shrink-0 flex items-center justify-center rounded-full bg-purple-100 dark:bg-purple-900/30 text-purple-700 dark:text-purple-300">
                        ...
                        <div>
                          ...
                          <p className="font-medium text-gray-900 dark:text-white">{terreiro?.contact}</p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="space-y-4">
                      <div className="flex items-start">
                        ...
                        <div>
                          <p className="text-sm text-gray-500 dark:text-gray-400">Segmento</p>
                          <p className="font-medium text-gray-900 dark:text-white">{terreiro?.segment}</p>
                        </div>
                      </div>
                      <div className="flex items-start">
                        <div className="mr-3 h-9 w-9 flex-shrink-0 flex items-center justify-center rounded-full bg-purple-100 dark:bg-purple-900/30 text-purple-700 dark:text-purple-300">
                        ...
                        <div>
                          <p className="text-sm text-gray-500 dark:text-gray-400">Funcionamento</p>
                          <p className="font-medium text-gray-900 dark:text-white">{terreiro?.opening_hours}</p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="space-y-4">
                      <div className="flex items-start">
                        ...
                        <div>
                          <p className="text-sm text-gray-500 dark:text-gray-400">Federação</p>
                          <p className="font-medium text-gray-900 dark:text-white">FENACAB</p>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <section>
                  <h2 className="text-xl font-bold text-purple-900 dark:text-white mb-4">Infraestrutura</h2>
                  <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                    {terreiro?.infrastructure || "Informações sobre a infraestrutura não disponíveis."}
                  </p>
                </section>
                ...
                <section>
                  <h2 className="text-xl font-bold text-purple-900 dark:text-white mb-4">Histórico</h2>
                  <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
            ...
            <TabsContent value="membros" className="p-4 md:p-8 focus:outline-none">
              <div className="grid grid-cols-1 gap-6">
                <div className="flex flex-col md:flex-row justify-between md:items-center">
                  <h2 className="text-2xl font-bold text-purple-900 dark:text-white mb-4 md:mb-0">Membros</h2>
                ...
                {terreiro && terreiro.agents.length === 0 && (
                  <div className="bg-purple-50 dark:bg-gray-800/50 rounded-xl p-6 border border-purple-100 dark:border-gray-800 text-center">
                    ...
                    <p className="text-purple-600 dark:text-purple-400 mt-2">
                      Este terreiro ainda não tem membros cadastrados na plataforma.
                    </p>
                  </div>
                )}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  {filteredUser.map((agent, index) => (
                    <Card key={index} className="overflow-hidden border border-gray-200 dark:border-gray-800 hover:shadow-md transition-all duration-300 rounded-xl">
                      <CardHeader className="pb-2">
                        <div className="flex items-center">
                          ...
                          <div className="ml-4">
                            <CardTitle className="text-lg text-purple-900 dark:text-white">{agent.user.name}</CardTitle>
                      ...
                      <CardContent className="pt-2">
                        <p className="text-sm text-gray-600 dark:text-gray-400 line-clamp-2">
                          {agent.role.description || "Sem descrição disponível."}
                        </p>
                      </CardContent>
                      ...
                      <CardFooter className="flex justify-between items-center pt-2 border-t border-gray-100 dark:border-gray-800">
                        ...
                        >
                          <Link to={"/users/" + agent.user.id} className="flex items-center">
                            Visitar Perfil
                          </Link>
                        </Button>
                      </CardFooter>
            ...
            <TabsContent value="eventos" className="p-8 focus:outline-none">
              <div className="flex justify-center items-center py-16">
                <div className="text-center">
                  ...
                  <h3 className="text-xl font-medium text-gray-600 dark:text-gray-400">Nenhum evento disponível</h3>
            ...
            <TabsContent value="fotos" className="p-8 focus:outline-none">
              <div className="flex justify-center items-center py-16">
                <div className="text-center">
                  ...
                  <h3 className="text-xl font-medium text-gray-600 dark:text-gray-400">Nenhuma foto disponível</h3>
                  <p className="mt-2 text-gray-500 dark:text-gray-500">
            ...
            <TabsContent value="avaliacao" className="p-8 focus:outline-none">
              <div className="flex justify-center items-center py-16">
                <div className="text-center">
                  ...
                  <h3 className="text-xl font-medium text-gray-600 dark:text-gray-400">Nenhuma avaliação disponível</h3>
                  <p className="mt-2 text-gray-500 dark:text-gray-500">
                    Seja o primeiro a avaliar este terreiro.
                  </p>
                  <Button 
                    className="mt-6 rounded-full bg-purple-700 hover:bg-purple-800 text-white shadow-md px-6"
                  >
                    Avaliar Terreiro
                  </Button>
                </div>
