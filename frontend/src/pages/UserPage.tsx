          ...
          <Tabs defaultValue="sobre" className="w-full">
            <div className="border-b border-gray-200 dark:border-gray-800 px-4 md:px-8">
              <TabsList className="bg-transparent h-14">
                ...
                <TabsTrigger value="terreiros" className="data-[state=active]:text-purple-700 data-[state=active]:shadow-none data-[state=active]:border-b-2 data-[state=active]:border-purple-700 rounded-none h-14 px-4">
            ...
            <TabsContent value="sobre" className="p-4 md:p-8 focus:outline-none">
              <div className="grid grid-cols-1 gap-8">
                <section>
                  <h2 className="text-2xl font-bold text-purple-900 dark:text-white mb-6">Informações do Perfil</h2>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex items-start">
                        ...
                        <div>
                          ...
                          <p className="font-medium text-gray-900 dark:text-white">email@exemplo.com</p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="space-y-4">
                      <div className="flex items-start">
                        ...
                        <div>
                          ...
                          <p className="font-medium text-gray-900 dark:text-white">(71) 99999-9999</p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start">
                        ...
                        <div>
                          ...
                          <p className="font-medium text-gray-900 dark:text-white">Salvador, Bahia</p>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <section>
                  <h2 className="text-xl font-bold text-purple-900 dark:text-white mb-4">Biografia</h2>
            ...
            <TabsContent value="terreiros" className="p-4 md:p-8 focus:outline-none">
              <div className="grid grid-cols-1 gap-6">
                <h2 className="text-2xl font-bold text-purple-900 dark:text-white">Terreiros</h2>
                  ...
                  {user?.agents?.map((agent, index) => (
                    <Card key={index} className="overflow-hidden border border-gray-200 dark:border-gray-800 hover:shadow-md transition-all duration-300 rounded-xl">
                      ...
                      <CardHeader className="pb-2">
                        <CardTitle className="text-lg text-purple-900 dark:text-white">{agent.terreiro.name}</CardTitle>
                      ...
                      <CardContent className="pb-2">
                        ...
                        <p className="mt-2 text-sm text-gray-600 dark:text-gray-400 line-clamp-2">
                          {agent.role.description || `Atua como ${agent.role.position} neste terreiro.`}
                        </p>
                      </CardContent>
                      <CardFooter className="flex flex-col sm:flex-row gap-2 justify-between pt-2">
                        ...
                        >
                          <Link to={"/terreiros/" + agent.terreiro.id} className="flex items-center justify-center w-full">
                            <Heart className="mr-2 h-4 w-4" />
                            Seguir
                          </Link>
                        </Button>
