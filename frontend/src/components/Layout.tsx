...
import { Moon, Sun, LogOut, Heart, User, PlusCircle, Facebook, Twitter, Instagram, MapPin, Phone, Mail, Menu, X, Search } from "lucide-react";
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="hidden md:flex items-center justify-between w-full h-16">
            <div className="flex items-center space-x-10">
              <Link to="/" className="text-2xl md:text-3xl font-bold text-yellow-400 hover:text-yellow-300 transition-all duration-300">
                Espiritus
              </Link>
              ...
              <nav className="flex items-center space-x-8">
                ...
                <div className="group relative">
                  ...
                  <div className="absolute left-0 top-full mt-1 w-48 bg-white dark:bg-gray-900 rounded-md overflow-hidden opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 shadow-lg z-50">
                    <div className="py-1">
                      <Link to="/" className="block px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-purple-50 dark:hover:bg-gray-800">Lojas</Link>
                      <Link to="/" className="block px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-purple-50 dark:hover:bg-gray-800">Federações</Link>
          ...
          <div className="flex md:hidden items-center justify-between w-full h-16">
            {/* Logo */}
            <Link to="/" className="text-2xl font-bold text-yellow-400 hover:text-yellow-300 transition-all duration-300">
              Espiritus
            </Link>
          ...
          <div 
            className={`md:hidden transition-all duration-300 ease-in-out overflow-hidden ${
              isSearchOpen ? "max-h-28 opacity-100 py-6" : "max-h-0 opacity-0 py-0"
            }`}
          >
            <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <div className="flex flex-col space-y-3">
                <div className="flex items-center">
                  ...
                  <span className="text-gray-200 dark:text-gray-300">Atibaia, São Paulo, Brasil</span>
                </div>
                <div className="flex items-center">
                  <Phone className="mr-2 h-5 w-5 text-yellow-300" />
                  <span className="text-gray-200 dark:text-gray-300">(11) 99999-9999</span>
                </div>
                <div className="flex items-center">
